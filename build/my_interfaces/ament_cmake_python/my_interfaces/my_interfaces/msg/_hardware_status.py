    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_interfaces.msg.HardwareStatus')
            logger.debug(
...
class HardwareStatus(metaclass=Metaclass_HardwareStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.tempreture = kwargs.get('tempreture', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.tempreture != other.tempreture:
            return False
    ...
    def tempreture(self, value):
        if __debug__:
            assert \
                ...
                "The 'tempreture' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'tempreture' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
