...
bool my_interfaces__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_interfaces.msg._hardware_status.HardwareStatus", full_classname_dest, 49) == 0);
  }
  my_interfaces__msg__HardwareStatus * ros_message = _ros_message;
  {  // tempreture
    PyObject * field = PyObject_GetAttrString(_pymsg, "tempreture");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->tempreture = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // are_motors_ready
...
PyObject * my_interfaces__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_interfaces.msg._hardware_status");
  ...
  {  // tempreture
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->tempreture);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tempreture", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
