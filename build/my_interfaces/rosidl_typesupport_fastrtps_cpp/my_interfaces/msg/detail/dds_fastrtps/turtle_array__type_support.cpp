...
#include "my_interfaces/msg/detail/turtle_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const my_interfaces::msg::Turtle &,
...
cdr_serialize(
  const my_interfaces::msg::TurtleArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interfaces::msg::TurtleArray & ros_message)
{
  // Member: turtles
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Turtle(
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces::msg::TurtleArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, msg, TurtleArray)() {
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
