...
#include "my_interfaces/msg/detail/led_state_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_interfaces::msg::LedStateArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interfaces::msg::LedStateArray & ros_message)
{
  // Member: led_states
  {
    cdr >> ros_message.led_states;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces::msg::LedStateArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_interfaces::msg::LedStateArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces::msg::LedStateArray *>(
    untyped_ros_message);
...
{
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_LedStateArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, msg, LedStateArray)() {
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_LedStateArray__handle;
}
