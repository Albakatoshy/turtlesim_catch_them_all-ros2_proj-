...
{
public:
  explicit Init_SetLed_Request_state(::my_interfaces::srv::SetLed_Request & msg)
  : msg_(msg)
  {}
  ::my_interfaces::srv::SetLed_Request state(::my_interfaces::srv::SetLed_Request::_state_type arg)
  {
...
public:
  ...
  {}
  Init_SetLed_Request_state led_number(::my_interfaces::srv::SetLed_Request::_led_number_type arg)
  {
...
{
  return my_interfaces::srv::builder::Init_SetLed_Request_led_number();
}
