...
#include "my_interfaces/msg/detail/turtle_array__rosidl_typesupport_fastrtps_c.h"
...
#include "my_interfaces/msg/detail/turtle__functions.h"  // turtles

// forward declare type support functions
size_t get_serialized_size_my_interfaces__msg__Turtle(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_my_interfaces__msg__Turtle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, msg, Turtle)();


using _TurtleArray__ros_msg_type = my_interfaces__msg__TurtleArray;
  ...
  // Field name: turtles
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, my_interfaces, msg, Turtle
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: turtles
  {
    ...
    if (ros_message->turtles.data) {
      my_interfaces__msg__Turtle__Sequence__fini(&ros_message->turtles);
    }
    if (!my_interfaces__msg__Turtle__Sequence__init(&ros_message->turtles, size)) {
...
size_t get_serialized_size_my_interfaces__msg__TurtleArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TurtleArray__ros_msg_type * ros_message = static_cast<const _TurtleArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_my_interfaces__msg__Turtle(
...
static uint32_t _TurtleArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interfaces__msg__TurtleArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interfaces
size_t max_serialized_size_my_interfaces__msg__TurtleArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_my_interfaces__msg__Turtle(
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces__msg__TurtleArray;
    is_plain =
      (
...
static size_t _TurtleArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_interfaces__msg__TurtleArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, msg, TurtleArray)() {
