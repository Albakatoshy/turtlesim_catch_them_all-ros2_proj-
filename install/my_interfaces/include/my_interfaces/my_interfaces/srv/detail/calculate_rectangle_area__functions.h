...
#ifndef MY_INTERFACES__SRV__DETAIL__CALCULATE_RECTANGLE_AREA__FUNCTIONS_H_
#define MY_INTERFACES__SRV__DETAIL__CALCULATE_RECTANGLE_AREA__FUNCTIONS_H_
 ...
 * calls
 * my_interfaces__srv__CalculateRectangleArea_Request__init().
...
/**
 * It calls
 * my_interfaces__srv__CalculateRectangleArea_Request__fini()
 ...
 * my_interfaces__srv__CalculateRectangleArea_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * my_interfaces__srv__CalculateRectangleArea_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_interfaces__srv__CalculateRectangleArea_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
...
/**
 * It calls
 * my_interfaces__srv__CalculateRectangleArea_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
...
/**
 * It allocates the memory for the array and calls
 * my_interfaces__srv__CalculateRectangleArea_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
...
/**
 * It calls
 * my_interfaces__srv__CalculateRectangleArea_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_INTERFACES__SRV__DETAIL__CALCULATE_RECTANGLE_AREA__FUNCTIONS_H_
